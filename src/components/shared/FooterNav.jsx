...
const FooterNav = () => {
  return (
    <div className="text-[#ababab] fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <button className="flex items-center justify-center"><MdOutlineReorder className="inline mr-2" size={20} /> <p>Orders</p></button>
      <button className="flex items-center justify-center"><MdTableBar className="inline mr-2" size={20} /> <p>Tables</p></button>
      <button className="flex items-center justify-center"><Ellipsis className="inline mr-2" size={20} /> <p>More</p></button>
