    ...
    <div className="text-[#ababab] fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Create Order">
        ...
        <div>
          ...
          <div className="flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]">
            <input className="bg-transparent flex-1 text-white focus:outline-none" type="number" name="" placeholder="+1-1111-1111" id="" />
          </div>
        </div>
        <div>
        ...
        <button onClick={()=> navigate('/tables')} className="w-full bg-[#f6b100] text-[#f5f5f5] rounded-lg py-3 mt-6 hover:text-yellow-700">
            Create Order
        </button>
      </Modal>
